...
public class MainActivity extends Activity {
	...
	Button btnPlus,btnMinus,btnTimes,btnClear,btnEqual,btnDiv;//number digit
	double numberOne=0;
	double numberTwo=0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnDiv.setOnClickListener(myOperationListner);
	...
	void performMath() //when user clicks on any button
	{
		...
		{
			doDivision (value1, value2);
		}
		operationdone = true;
	}


	private void doAddition(String value1, String value2)
	{
	...
	private void doSubtraction(String value1, String value2) {
	...
	private void doMultiplication(String value1, String value2)
	{
		int number1 = Integer.parseInt(value1);
		int number2 = Integer.parseInt(value2);
	...
	private void doDivision(String value1, String value2)
	{
		int number1 = Integer.parseInt(value1);
		int number2 = Integer.parseInt(value2);
